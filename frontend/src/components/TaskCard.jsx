        ...
        >
            <div className="flex items-center gap-4">
                ...
                <Button variant={"ghost"} size={'icon'} className={cn(
                    "flex-shrink-0 size-8 rounded-full transition-all duration-200", task.status==='complete' ?'text-success hover:text-success/80':
                ...
                <div className="flex-1 min-w-0">
                    {isEditting ? (
                        <Input placeholder='Cần phải làm gì?' className={"flex-1 h-12 text-base border-border/50 focus:border-primary/50 focus:ring-primary/20"} />
                    ): (
                        <p className={cn(
